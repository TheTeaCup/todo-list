...
export default function Home() {
    ...
    const [text, setText] = useState('This is a free ToDo List Application');
    ...
    function createAccount() {
        setStep('create');
        setText('Enter a username & password to create an account')
        setLoading(false);
        setError(null);
    }
    ...
    function alreadyAccount() {
        setStep('login')
        setText('This is a free ToDo List Application')
        setLoading(false);
        setError(null);
    }
